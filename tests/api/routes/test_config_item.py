...
def test_delete_config_item(
    ...
    # Then the item de configuracion is deleted and returned
    assert 200 <= r.status_code < 300
...
def test_delete_config_item_invalid_uuid(
    ...
    # Given a uuid that's not linked to any config_item
    id_config_item = "1c6f2b84-25f2-4032-b37b-eabca65a4fb3"

    # When the user uses it to delete a config_item
...
# ) -> None:
#     # Given a item_config
#     item_config_created = create_random_item_config(client, empleado_token_headers)
#
...
#     assert 400 <= r.status_code < 500
#
#     r = client.get(f"{BASE_URL}/{item_config_created['id']}", headers=empleado_token_headers)
#
#     assert 200 <= r.status_code < 300
#
#     item_config = r.json()
...
#     assert item_config["nombre"] == item_config_created["nombre"]
#     assert item_config["descripcion"] == item_config_created["descripcion"]
#     assert item_config["prioridad"] == item_config_created["prioridad"]
#     assert item_config["estado"] == item_config_created["estado"]
#     assert item_config["fecha_creacion"] == item_config_created["fecha_creacion"]
#     assert item_config["owner_id"] == item_config_created["owner_id"]
#     assert item_config["config_items"][0]["id"] == item_config_created["config_items"][0]["id"]
